...
- Accueil : une présentation personnelle entière disposée dans l’espace. Titre, actions, portrait sur une plaque sombre fine et étiquettes occupent des profondeurs distinctes, avec parallaxe au pointeur. Sur grand écran, le contenu reste centré dans une zone de lecture plafonnée et le portrait est borné par la hauteur disponible. Aucun écran de chargement obligatoire.
